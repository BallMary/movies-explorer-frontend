...
function Profile({ errorMessage, onSubmit, onLogout }) {
  ...
  return (
    <form className='profile'>
      ...
      <div className='profile__container'>
        ...
        <span className='profile__text profile__text_red'>
          {textEmailError}
        </span>
        <span
          className={`profile__text ${errorMessage ? 'profile__text_red' : ''}`}
        >
